...
namespace GURPS_GEN
{
    public partial class Form1 : Form
    {
       ...
       /* private Double[] methodOfCalculatingBaseArmorStats(int armorDR, Double materialWeightMultiplier, Double materialCostMultiplier)
        ...
        private void GoButtonName_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    textBoxOutput.Text = comboBox1.Text.Replace("ое", "ая") + " броня из " + methodMaterialLinesToData(ComboBoxMaterial.Text)[2] + "" + " с ДР " + Convert.ToString(dr + finalOtherStuff[3]) + " весит " + Convert.ToString(outputText[0]) + " фунтов и стоит " + Convert.ToString(outputText[1] + finalOtherStuff[2] + "$") + finalStringStuff.TrimEnd(',') + "." ;
                }
            }
